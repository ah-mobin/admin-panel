...
@section('title','All Executive Members')
...
<div class="content-page">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-primary mb-5" data-toggle="modal" data-target="#addNewExMember">
                       Add New Member
                    </button>
                        ...
                        <tbody>
                            @foreach($executives as $member)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('executive/member/view/'.$member->id) }}"> <i class="fa fa-eye mr-4"></i> </a>
                                        <a href="{{ url('executive/member/edit/'.$member->id) }}"> <i class="fa fa-edit mr-4"></i> </a>
                                        <a href="{{ url('executive/member/remove/'.$member->id) }}"> <i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
  ...
  <!-- Modal -->
  <div class="modal fade" id="addNewExMember" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="addNewExMemberLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addNewExMemberLabel">Add New Member</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>

        <form action="{{ route('store.executive') }}" method="post" enctype="multipart/form-data">
            @csrf
